              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                {selectedBookingId && selectedBooking && (
                  <>
                    ...
                    />
                    <div className="fixed inset-x-4 top-1/2 -translate-y-1/2 z-50 max-h-[85vh] overflow-y-auto lg:static lg:translate-y-0 lg:z-0 lg:max-h-none lg:w-auto bg-white rounded-3xl border border-gray-200/50 shadow-2xl lg:shadow-[0_8px_30px_rgba(0,0,0,0.02)] p-6 space-y-6 self-start relative">
                    <button 
                      onClick={() => setSelectedBookingId(null)}
